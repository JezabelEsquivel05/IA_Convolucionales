...
imagen = cv2.imread('circulos.jpg')
...
if circulos is not None:
    ...
    for (x, y, r) in circulos:
        ...
        cv2.circle(imagen, (x, y ), 2,(0, 0, 255, 0), 3)
        pixel_distancia = np.sqrt((x -referencia_circulo[0]) ** 2 + (y - referencia_circulo[1]))
...
cv2.imshow("Distancia entre cárculos", imagen)
cv2.waitKey(0)
